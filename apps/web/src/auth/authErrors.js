const MSG_INVALID_CREDENTIALS = "E-posta veya şifre hatalı. Şifreyi kontrol et; hesabın yoksa kayıt ol. " +
    "Yeni kayıt olduysan önce gelen kutudaki doğrulama bağlantısına tıkla.";
const MSG_EMAIL_NOT_CONFIRMED = "E-posta adresin henüz doğrulanmamış. Gelen kutundaki Supabase doğrulama mailine tıkladıktan sonra tekrar giriş yap.";
