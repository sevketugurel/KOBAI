...
export default function RegisterPage() {
    ...
    async function onSubmit(e) {
        ...
        if (!sessionData.session) {
            ...
            setBusy(false);
            setError("Hesabın oluşturuldu! E-postana bir doğrulama bağlantısı gönderdik. " +
