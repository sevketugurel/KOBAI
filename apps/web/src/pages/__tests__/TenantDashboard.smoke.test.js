...
function renderPage() {
    ...
    return render(_jsx(QueryClientProvider, { client: client, children: _jsx(MemoryRouter, { initialEntries: ["/acme-co/dashboard"], children: _jsx(Routes, { children: _jsx(Route, { path: ":slug/dashboard", element: _jsx(TenantDashboard, {}) }) }) }) }));
}
